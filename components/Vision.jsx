        ...
        <div className='container'>
          ...
          <div className='row'>
            <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-xs-12">
              <Image className="img-fluid" src={Image1} itemProp='image'/>
            </div>
            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-xs-12">
              ...
              <h4 className="sub-heading" itemProp='Principal'>Mrs Rituraj Gaur </h4>
              <p className="paragraph" itemProp='description'>Principal, M Pharm ( Pharmaceutics )</p>
            </div>
          </div>
        </div>
      </section>
