...
function Eligibility() {
  return (
    <>
      <section itemscope itemtype="https://schema.org/Eligibility" className="  section-margin course section-background-color">
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <h2 className="mb-5 text-center text-white heading" itemProp='title'> Eligibility Criteria</h2>
            </div>
            <div className='row'>
